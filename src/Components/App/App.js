...
class App extends Component{
  ...
  savePlaylist(){
    let nameToSpotify = this.state.playlistName;
    let trackURIs = [];

    this.state.playlistName.map(function(track){
      trackURIs.push(track.uri);
    });
    Spotify.savePlaylist(nameToSpotify,trackURIs);

    this.setState({playlistName: 'aa'});
